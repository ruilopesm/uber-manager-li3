...
void *query7(JOINT_CATALOG catalog, STATS stats, char **parameter) {
...
JOINT_CATALOG get_query8_result_catalog(QUERY8_RESULT query8_result) {
...
JOINT_CATALOG get_query9_result_catalog(QUERY9_RESULT query9_result) {
